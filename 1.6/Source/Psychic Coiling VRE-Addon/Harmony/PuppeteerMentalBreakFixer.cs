...
namespace Psychic_Coiling_VRE_Addon
{
    ...
    public static class PuppeteerCompatibility
    {
        public static void HandlePuppeteerCompatibility(Harmony harm)
        {
            if (ModsConfig.IsActive("VanillaExpanded.VPE.Puppeteer"))
            {
                PuppeteerHandlerSlave.CheckForAndHandlePuppeteerMod(harm);
